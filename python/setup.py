...
def check_python_version():
    ...
    if version.major == 3 and 8 <= version.minor <= 11:
        ...
        print(f"⚠ Python {version.major}.{version.minor}.{version.micro} detected")
        print(f"  WARNING: Demucs officially supports Python 3.8-3.11")
        print(f"  Python 3.{version.minor} might not work correctly.")
        print(f"  Recommended: Install Python 3.11 from https://www.python.org/downloads/release/python-31110/")
        return False
    else:
        print(f"✗ Python 3.8-3.11 required, but {version.major}.{version.minor}.{version.micro} found")
        return False
...
def main():
    ...
    if not check_python_version():
        ...
        print("Please install Python 3.11 from https://www.python.org/downloads/release/python-31110/")
        sys.exit(1)
